...
def get_raw_dataset(dataset_name, output_path, seed, local_rank):
    ...
    if "Dahoas/rm-static" in dataset_name:
        ...
        return raw_datasets.LmqgQagjaquadDataset(output_path, seed, local_rank,
                                                 dataset_name)
    elif "alpaca_farm" in dataset_name and "instructions" in dataset_name:
        return raw_datasets.AlpacaFarmDataset(output_path, seed, local_rank,
                                              dataset_name)
    elif "alpaca_farm" in dataset_name and "rlhf" in dataset_name:
        return raw_datasets.AlpacaFarmPPODataset(output_path, seed, local_rank,
                                              dataset_name)
    elif "alpaca_farm" in dataset_name and "comparisons" in dataset_name:
        return raw_datasets.AlpacaFarmComparisonsDataset(output_path, seed, local_rank,
                                              dataset_name)
    elif "tldr_3_filtered" in dataset_name:
        return raw_datasets.TLDR3FilteredDataset(output_path, seed, local_rank,
                                                 dataset_name)
    elif "Anthropic/hh-rlhf" in dataset_name:
        return raw_datasets.AnthropichhrlhfDataset(output_path, seed, local_rank,
                                                   dataset_name)
    elif all([i in dataset_name for i in ['summarize-from-feedback', 'comparisons']]):
        return raw_datasets.TLDR3FilteredHumanFeedbackDataset(output_path, seed, local_rank,
                                                              dataset_name)
