...
def get_tokenizer(model_name_or_path, fast_tokenizer=True, model_type=""):
    if "llama" in model_name_or_path or model_type == "llama":
        ...
        print("Not Using llama tokenizer...")
    ...
    if os.path.exists(model_name_or_path):
        ...
        if os.path.exists(model_json):
            ...
            model_name = model_json_file.get("_name_or_path",
                                             model_name_or_path)
            model_type = model_json_file.get("model_type", "")
